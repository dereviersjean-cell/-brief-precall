    ...
    return (
      <div className="flex items-center gap-2">
        <input
          ...
          className="text-2xl font-bold text-slate-900 border border-slate-300 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        />
        <button
          onClick={commit}
          disabled={saving}
          className="h-8 w-8 flex items-center justify-center rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition-colors duration-200 disabled:opacity-50"
    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-5">
      ...
      <div className="flex items-center gap-4 mt-4 pb-4 border-b border-slate-100">
        <label className="flex items-center gap-2 text-xs text-slate-500">
          ...
          <input
            ...
            className="w-14 border border-slate-200 rounded-lg px-2 py-1 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
          />
        </label>
      ...
      >
        <input
          ...
          className="flex-1 border border-slate-200 rounded-lg px-2.5 py-1.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        />
        <button
          type="submit"
          disabled={!newQuestion.trim()}
          className="h-8 px-3 flex items-center gap-1.5 rounded-lg bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-colors duration-200 disabled:opacity-50"
        >
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-20 px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
        </div>

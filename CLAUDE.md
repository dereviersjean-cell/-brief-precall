...
- **Ancrer sur CE DONT LA BULLE PARLE**, pas sur le conteneur de page : la rangée de chiffres pour « votre tableau de bord une fois alimenté », la liste de calls pour « un compte-rendu par rendez-vous », les tuiles de métriques pour Analytics. Un conteneur de page entier déclenche en plus la règle « couvre l'écran » et supprime la surbrillance, donc on ne met plus rien en évidence.
